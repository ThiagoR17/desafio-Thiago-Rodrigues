...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['chantily', 'dinheiro', 'Chantily (extra do Café) não pode ser pedido sem o Café', ['chantily,1']],
        ['queijo', 'credito', 'Queijo (extra do Sanduíche) não pode ser pedido sem o Sanduíche', ['queijo,1']],
        ['chantily com outro item', 'credito', 'Chantily (extra do Café) não pode ser pedido sem o Café', ['chantily,1', 'sanduiche,1']],
        ['queijo com outro item', 'debito', 'Queijo (extra do Sanduíche) não pode ser pedido sem o Sanduíche', ['cafe,1', 'queijo,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
